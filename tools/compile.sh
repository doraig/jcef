...
if [ -z "$1" ]; then
  ...
  javac -Xdiags:verbose -cp $CLS_PATH -d $OUT_PATH java/tests/detailed/*.java java/tests/simple/*.java java/org/org.cef/*.java java/org/org.cef/browser/*.java java/org/org.cef/callback/*.java java/org/org.cef/handler/*.java java/org/org.cef/misc/*.java java/org/org.cef/network/*.java
