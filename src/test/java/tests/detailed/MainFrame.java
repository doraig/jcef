...
public class MainFrame extends BrowserFrame {
    ...
    public MainFrame(boolean osrEnabled, boolean transparentPaintingEnabled,
        ...
        menuBar.addBookmark(
                "javachromiumembedded", "https://bitbucket.org/chromiumembedded/java-org.cef");
        menuBar.addBookmark("chromiumembedded", "https://bitbucket.org/chromiumembedded/org.cef");
        setJMenuBar(menuBar);
    }
